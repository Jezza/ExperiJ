...
import me.jezza.experij.asm.ExperiJClassTransformer;
...
public final class ExperiJ {
	...
	public static void setup(String experimentName) {
		if (RESULT_MAP.containsKey(experimentName))
			throw new IllegalStateException(Strings.format("Different Experiment Sets have the same name: {}", experimentName));
